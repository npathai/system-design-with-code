...
public class ServiceTags {
    ...
    public static Tags serviceTags(String serviceName, String serviceModule, String operation) {
        return Tags.of(Tag.of("service", serviceName), Tag.of("service.module", serviceModule),
                Tag.of("service.operation", operation));
    }

    public static class DatabaseTags {
        public static Tags databaseTags(String serviceName, String serviceModule, String operation) {
            return Tags.of(Tag.of("service", serviceName), Tag.of("service.module", serviceModule),
                    Tag.of("database.operation", operation));
        }

        public static Tags databaseSuccessTags(Tags commonTags) {
            return commonTags.and("database.operation.result", "success");
        }

        public static Tags databaseErrorTags(Tags commonTags) {
            return commonTags.and("database.operation.result", "error");
        }
    }
}
